...
namespace OpenSource.Data.HashFunction.MetroHash
{
    ...
    internal class MetroHash64_Implementation
        : HashFunctionAsyncBase,
            IMetroHash64
    {
        private const UInt64 k0 = 0xD6D018F5;
        private const UInt64 k1 = 0xA2AA033B;
        private const UInt64 k2 = 0x62992FC1;
        private const UInt64 k3 = 0x30BC5B29;
        ...
        private class InternalState
        {
            ...
            {
                _initialValue = (seed + k2) * k0;

                _workingValues = Enumerable.Repeat(_initialValue, 4)
                    .ToArray();
            }
            ...
            private void ExecutePostFullGroup()
            {
                ...
                {
                    _workingValues[2] ^= RotateRight(((_workingValues[0] + _workingValues[3]) * k0) + _workingValues[1], 37) * k1;
                    _workingValues[3] ^= RotateRight(((_workingValues[1] + _workingValues[2]) * k1) + _workingValues[0], 37) * k0;
                    _workingValues[0] ^= RotateRight(((_workingValues[0] + _workingValues[2]) * k0) + _workingValues[3], 37) * k1;
                    _workingValues[1] ^= RotateRight(((_workingValues[1] + _workingValues[3]) * k1) + _workingValues[2], 37) * k0;


                    _workingValues[0] = _initialValue + (_workingValues[0] ^ _workingValues[1]);
                }
            }
            ...
            public void ProcessRemainder(byte[] array, int start, int count)
            {
                ...
                if (count >= 16)
                {
                    _workingValues[1] = _workingValues[0] + (BitConverter.ToUInt64(array, start) * k2);
                    _workingValues[1] = RotateRight(_workingValues[1], 29) * k3;

                    _workingValues[2] = _workingValues[0] + (BitConverter.ToUInt64(array, start + 8) * k2);
                    _workingValues[2] = RotateRight(_workingValues[2], 29) * k3;

                    _workingValues[1] ^= RotateRight(_workingValues[1] * k0, 21) + _workingValues[2];
                    _workingValues[2] ^= RotateRight(_workingValues[2] * k3, 21) + _workingValues[1];
                    _workingValues[0] += _workingValues[2];
                ...
                if (count >= 8)
                {
                    _workingValues[0] += BitConverter.ToUInt64(array, start) * k3;
                    _workingValues[0] ^= RotateRight(_workingValues[0], 55) * k1;
                ...
                if (count >= 4)
                {
                    _workingValues[0] += BitConverter.ToUInt32(array, start) * k3;
                    _workingValues[0] ^= RotateRight(_workingValues[0], 26) * k1;
                ...
                if (count >= 2)
                {
                    _workingValues[0] += BitConverter.ToUInt16(array, start) * k3;
                    _workingValues[0] ^= RotateRight(_workingValues[0], 48) * k1;
                ...
                if (count >= 1)
                {
                    _workingValues[0] += array[start] * k3;
                    _workingValues[0] ^= RotateRight(_workingValues[0], 37) * k1;
                }
            }
            ...
            public byte[] GetResult()
            {
                ...
                _workingValues[0] ^= RotateRight(_workingValues[0], 28);
                _workingValues[0] *= k0;
                _workingValues[0] ^= RotateRight(_workingValues[0], 29);

                return BitConverter.GetBytes(_workingValues[0]);
            }
